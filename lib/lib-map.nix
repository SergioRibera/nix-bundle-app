{
  ...
  sonameMap = {
    ...
    "libgdk_pixbuf-2.0.so.0" = {
      deb = "libgdk-pixbuf-2.0-0";
      rpm = "gdk-pixbuf2";
      archlinux = "gdk-pixbuf2";
    };
    "libcairo.so.2" = {
      deb = "libcairo2";
      rpm = "cairo";
    ...
    "libwayland-cursor.so.0" = {
      deb = "libwayland-cursor0";
      rpm = "libwayland-cursor";
      archlinux = "wayland";
    };
